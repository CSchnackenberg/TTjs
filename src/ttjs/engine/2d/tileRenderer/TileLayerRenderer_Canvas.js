...
define(["require", "exports"], function (require, exports) {
    ...
    TileLayerRenderer.prototype = {
        ...
        drawLayer: function (context, mapInfo, layerIndex, position) {
            ...
            var currentLayer = mapInfo.getLayer(layerIndex), tileWidth = currentLayer.getTileWidth(), tileHeight = currentLayer.getTileHeight(), rangeX = (context.canvas.width - position.dest.x) / tileWidth, rangeY = (context.canvas.height - position.dest.y) / tileHeight, tileOffset, x, y, pX, pY, iBounds, tileId, tileSet;
...
// });
//# sourceMappingURL=TileLayerRenderer_Canvas.js.map