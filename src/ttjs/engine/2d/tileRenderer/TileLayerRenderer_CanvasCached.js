...
define(["require", "exports"], function (require, exports) {
    ...
    TileLayerRenderer.prototype = {
        ...
        /* draws the layer */
        drawLayer: function (context, mapInfo, layerIndex, position) {
            var currentLayer = mapInfo.getLayer(layerIndex), tileWidth = currentLayer.getTileWidth(), tileHeight = currentLayer.getTileHeight(), tileOffset;
        ...
        redraw: function (context, mapInfo, layerIndex, position) {
            var currentLayer = mapInfo.getLayer(layerIndex), tileWidth = currentLayer.getTileWidth(), tileHeight = currentLayer.getTileHeight(), rangeX = (context.canvas.width - position.dest.x) / tileWidth, rangeY = (context.canvas.height - position.dest.y) / tileHeight, pX, pY, tileOffset, x, y, tileId, tileSet, iBounds;
...
// });
//# sourceMappingURL=TileLayerRenderer_CanvasCached.js.map