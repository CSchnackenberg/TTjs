...
//     'ttjs/util/WebGL',
//     'ttjs/lib/gl-matrix',
//     'text!ttjs/engine/2d/tileRenderer/shaders/SimpleTileShader.vsh',
//     'text!ttjs/engine/2d/tileRenderer/shaders/SimpleTileShader.fsh'
// ], function (
//     WebGLUtils,
//     GLMatrix,
//     vertexShaderSource,
...
import {WebGLUtils} from "../../../util/WebGL"
import * as GLMatrix from "@ttjs/lib/gl-matrix"
import {vertexShaderSource} from "@ttjs/engine/2d/tileRenderer/Shader";
import {fragmentShaderSource} from "@ttjs/engine/2d/tileRenderer/Shader";


"use strict";
export function TileLayerRenderer_WebGL() {
...
TileLayerRenderer_WebGL.prototype = {
    ...
    initialize: function (gl) {
        ...
        //create shaders
        vertexShader = WebGLUtils.compileShader(gl, vertexShaderSource, gl.VERTEX_SHADER);
        fragmentShader = WebGLUtils.compileShader(gl, fragmentShaderSource, gl.FRAGMENT_SHADER);
    ...
    initializeLayerBuffer: function (gl, mapInfo, layerIndex) {
        ...
        var layer = mapInfo.getLayer(layerIndex),
            tileSetSwitch:any[] = [],
            data:any[] = [],
        ...
        for (y = 0; y < layer.getHeight(); y++) {
            for (x = 0; x < layer.getWidth(); x++) {
                ...
                var startX = x * layer.getTileWidth();
                var startY = y * layer.getTileHeight();
