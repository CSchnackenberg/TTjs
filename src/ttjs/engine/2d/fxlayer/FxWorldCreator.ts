...
import {TileLayerRenderer as TileLayerRenderer_Canvas} from "@ttjs/engine/2d/tileRenderer/TileLayerRenderer_Canvas";
import {MapRenderModel} from "@ttjs/engine/map/tiled/MapRenderModel";
import {FxWorld} from "@ttjs/engine/2d/fxlayer/FxWorld";
import {ResourceManager} from "@ttjs/entity/ResourceManager";
import {ImageResources} from "@ttjs/entity/resources/ImageResources";
import {TextResources} from "@ttjs/entity/resources/TextResources";
import {LayerModel} from "@ttjs/engine/map/tiled/LayerModel";
import {FxTileLayer} from "@ttjs/engine/2d/fxlayer/FxTileLayer";
import {FxFillImage} from "@ttjs/engine/2d/fxlayer/FxFillImage";
import {FxFillGradient} from "@ttjs/engine/2d/fxlayer/FxFillGradient";
import {FxSpriteLayer} from "@ttjs/engine/2d/fxlayer/FxSpriteLayer";
import {TileSetModel} from "@ttjs/engine/map/tiled/TileSetModel";
 ...
 * @constructor
 */
export function FxWorldCreator(canvas, creatorListener) {
...
FxWorldCreator.prototype = {
    ...
    loadFromTiledMap: function(mapData) {
        var additionalAssets:any[] = [];
        var pendingImageFills:any[] = [];
        // buildup Layers
        var layerIndex = 0;
